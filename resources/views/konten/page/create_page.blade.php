...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-header text-center">Buat Halaman</div>

        <div class="card-body">

            <form method="post" role="form" action="{{ route('post_page') }}" enctype="multipart/form-data" id="myForm">
                
                {{ csrf_field() }}

                <div class="form-group row">
                    <label for="title" class="col-md-2 col-form-label text-md-left">{{ __('Judul Halaman') }}
                    </label>
                    <div class="col-md-10">
                ...
                <div class="form-group row">
                    <label for="content" class="col-md-2 col-form-label text-md-left">{{ __('Isi Halaman') }}</label>
                    <div class="col-md-10">
