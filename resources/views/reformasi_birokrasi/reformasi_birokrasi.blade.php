...
<body class="bg">
    {{-- navbar --}} @include('welcome._navbar_welcome') @include('welcome._navbar_welcome_2') @include('welcome._navbar_welcome_3') @include('reformasi_birokrasi.jumbotron')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                @include('reformasi_birokrasi.content')
            </div>
            <div class="col-md-3">
